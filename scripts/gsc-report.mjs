...
/* 4. INDEXED SHARE PER TEMPLATE, by inspecting a sample of each. URL Inspection is quota-
...
console.log(`\n4. index status — sampling up to ${SAMPLE} URL(s) per template of ${sitemapUrls.length} in the sitemaps`);
